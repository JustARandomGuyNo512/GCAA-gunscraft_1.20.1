...
public class Awp extends HandActionGun {
    public Awp() {
        super(new GunProperties(2.5f, 0.25f, 3f, 1.8f, 0.1f, 5f, GunProperties.toRPM(45),
                RenderAndMathUtils.secondsToTicks(2.25f), RenderAndMathUtils.secondsToTicks(3.35f), 10,
                3.5f, 1f, 0.1f, 0.1f, 22,
                List.of(new HandAction()), ModSounds.AWP_FIRE, ModSounds.AWP_FIRE_SUPPRESSED,
