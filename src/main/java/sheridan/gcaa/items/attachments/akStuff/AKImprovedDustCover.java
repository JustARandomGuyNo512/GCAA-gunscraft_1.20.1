...
public class AKImprovedDustCover extends SubSlotProvider {
    ...
    private final AttachmentSlot root = AttachmentSlot.root()
            .addChild(new AttachmentSlot("dust_cover_scope", Set.of("gcaa:red_dot", "gcaa:kobra_sight", "gcaa:canted_sight_set", "gcaa:holographic","gcaa:elcan", "gcaa:acog", "gcaa:okp7_b")).upper());
