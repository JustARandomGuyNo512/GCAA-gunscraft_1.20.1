...
public class AKImprovedHandguard extends Handguard {
    private static final AttachmentSlot root = AttachmentSlot.root()
            .addChild(new AttachmentSlot("handguard_grip", Set.of("gcaa:vertical_grip", "gcaa:gp_25", "gcaa:laser_sight", "gcaa:flashlight")).lower())
            .addChild(new AttachmentSlot("handguard_sight", Set.of("gcaa:red_dot", "gcaa:holographic", "gcaa:horizontal_laser_sight", "gcaa:okp7_b")).upper())
