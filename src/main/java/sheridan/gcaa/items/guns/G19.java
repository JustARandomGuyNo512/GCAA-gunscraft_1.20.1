...
public class G19 extends Gun {
    public G19() {
        super(new GunProperties(0f, 0f, GunProperties.getRPM(500), RenderAndMathUtils.secondsToTicks(2),
                RenderAndMathUtils.secondsToTicks(2.5f), 15, 1f, 1f, 0.1f, 0.1f, 5, List.of(Semi.SEMI),
