...
@OnlyIn(Dist.CLIENT)
public class SMGSuppressorModel extends MuzzleFlashRendererModel implements IAttachmentModel {
    private final ModelPart model;
    private final ModelPart muzzle;
    private final ResourceLocation texture = StatisticModel.MUZZLE_COLLECTION1.texture;

    public SMGSuppressorModel() {
        model = StatisticModel.MUZZLE_COLLECTION1.get("smg_suppressor").meshing();
        muzzle = model.getChild("smg_suppressor_muzzle");
    }
