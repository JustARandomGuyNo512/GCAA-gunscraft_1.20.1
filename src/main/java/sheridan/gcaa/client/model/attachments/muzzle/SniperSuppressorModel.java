...
@OnlyIn(Dist.CLIENT)
public class SniperSuppressorModel extends MuzzleFlashRendererModel implements IAttachmentModel {

    private final ModelPart model;
    private final ModelPart muzzle;
    private final ResourceLocation texture = StatisticModel.MUZZLE_COLLECTION2.texture;

    public SniperSuppressorModel() {
        model = StatisticModel.MUZZLE_COLLECTION2.get("sniper_suppressor").meshing();
        muzzle = model.getChild("sniper_suppressor_muzzle");
    }
