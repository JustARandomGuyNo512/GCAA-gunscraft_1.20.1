...
@OnlyIn(Dist.CLIENT)
public class NewAkmModel extends LodGunModel {
    private final ResourceLocation TEXTURE = new ResourceLocation(GCAA.MODID, "model_assets/guns/akm/akm.new.png");
    ...
    public NewAkmModel() {
        super(new ResourceLocation(GCAA.MODID, "model_assets/guns/akm/akm.geo.new.json"),
    ...
    protected void renderGunNormal(GunRenderContext context) {
        ...
        context.render(vertexConsumer, barrel, slide, safety, body);
