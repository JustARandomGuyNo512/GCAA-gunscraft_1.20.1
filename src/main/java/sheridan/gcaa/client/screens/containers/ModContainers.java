...
public class ModContainers {
    ...
    public static final RegistryObject<MenuType<BulletCraftingMenu>> BULLET_CRAFTING_MENU = REGISTER.register("bullet_crafting_menu", () -> new MenuType<>(BulletCraftingMenu::new, FeatureFlags.DEFAULT_FLAGS));
}
