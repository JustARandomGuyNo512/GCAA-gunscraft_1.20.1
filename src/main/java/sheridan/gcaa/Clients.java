...
public class Clients {
    ...
    public static void onSetUp(final FMLClientSetupEvent event) {
        ...
        ArsenalLib.registerGunModel(ModItems.G19.get(), new G19Model(), new DisplayData()
                ...
                .setAttachmentScreen(0.6f, -0.2f, -3.9f, POS).setAttachmentScreen(0f, 90f, 0, ROT).set(DisplayData.ATTACHMENT_SCREEN, 0.08f, SCALE)
        ...
        ArsenalLib.registerGunModel(ModItems.AKM.get(), new AkmModel(), new DisplayData()
                ...
                .setAds(0,14,-11, POS)
                .setAttachmentScreen(0.6f,-0.1f,-2.6f, POS).setAttachmentScreen(0f, 90f, 0, ROT).set(DisplayData.ATTACHMENT_SCREEN, 0.03f, SCALE)
